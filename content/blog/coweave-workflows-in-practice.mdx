...
**Start with CoWeave AI Platform** — Build your context components (base standards, role definitions, repository templates) in CE Studio. This is the foundation everything else builds on.
...
[**Try CoWeave AI Platform**](/platform) - Build your context components and see hierarchical assembly in action.
